# mainly copied from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/autoencoders/autoencoder_kl.py
...
from model.vae import Encoder, Decoder, DecoderOutput, DiagonalGaussianDistribution
